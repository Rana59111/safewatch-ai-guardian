...
CORS_ALLOWED_ORIGINS = os.environ.get('CORS_ALLOWED_ORIGINS', 'http://localhost:5173,http://127.0.0.1:5173,http://localhost:8080').split(',')

ROOT_URLCONF = 'safewatch.urls'
...
WSGI_APPLICATION = 'safewatch.wsgi.application'
